                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input id="Fname" type="text" name="Fname" class="form-control" placeholder="نام خود را وارد نمایید">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="Lname">نام خانوادگی</label>
                            <input id="Lname" type="text" name="Lname" class="form-control" placeholder="نام خانوادگی خود را وارد نمایید">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="PersonelCode">کدپرسنلی</label>
                            <input id="PersonelCode" type="text" name="PersonelCode" class="form-control" placeholder="کدپرسنلی خود را وارد نمایید">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input id="password" type="password" name="password" class="form-control" placeholder="رمزعبور را وارد نمایید">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="password_confirmation">تکرار رمز عبور</label>
                            <input id="password_confirmation" type="password" name="password_confirmation" class="form-control" placeholder="رمزعبور را مجدد وارد نمایید">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="MobileNumber">شماره موبایل</label>
                            <input id="MobileNumber" type="text" name="MobileNumber" class="form-control" placeholder="وارد کردن شماره موبایل" data-inputmask='"mask": "9999-999-9999"' data-mask>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="MobileNumber">شماره داخلی</label>
                            <input id="MobileNumber" type="text" name="MobileNumber" class="form-control" placeholder="وارد کردن شماره داخلی" data-inputmask='"mask": "9999-999-9999"' data-mask>
                        </div>
                    </div>
                </div>
                <div class="row">
